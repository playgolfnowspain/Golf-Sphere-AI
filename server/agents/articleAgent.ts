...
async function generateArticle(options?: {
  ...
  const userPrompt =
    ...
    [
      ...
      "",
      "IMPORTANT - At the end, add a '## Useful Links' section with real, working URLs:",
      "- Official course/tournament website",
      "- Book tee times (use the course's official booking page or a site like golfspain.com)",
      "- Nearby hotels (link to booking.com search for the area or a specific resort)",
      "- Car rental (link to rentalcars.com or similar for the nearest airport)",
      "",
      "Writing style:",
      ...
      "- All links must be real URLs that work",
      "",
